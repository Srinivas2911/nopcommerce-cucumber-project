...
public class Utility extends BasePage {
    ...
    public void sortingAtoZ (By by){
        ...
        List<WebElement> elementList = driver.findElements(by); // By.tagName ("h2")
    ...
    public void sortbyPrices (By by) {
        List<WebElement> elements = driver.findElements(by);  //By.className("prices")
        ...
        System.out.println("Expected Prices List : " + mySortedPrices);
        System.out.println("Actual Price List : " + webSortedPrices);
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/demo/nopcommerce";
...
// screenshot to main package folder
    ...
    /*
     Screenshot methods to test output
     */
